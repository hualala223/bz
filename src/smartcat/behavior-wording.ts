...
// ==================== knowledge（知识盒：视频转文献 + 术语生成，ADR-0066/0072；票 290 正名 knowledge） ====================
// 遗留兼容：票 290 改名前存量条目实体为 'literature'（更早还有 'bili'/'bili-downloader'），继续命中同套中文模板；
...
}, ['literature', 'bili', 'bili-downloader'], (s) => `知识盒动态：${s.name || '一部视频'}`);
